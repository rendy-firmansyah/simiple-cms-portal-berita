...
<form>
  <div class="row">
      <div class="col-md-6 mb-3">
          ...
          <input type="text" class="form-control" id="name" placeholder="Enter a name author">
      </div>
      <div class="col-md-6 mb-3">
...
<div class="d-sm-flex align-items-center justify-content-between mb-4 mt-5">
    <h5 class="h5 mb-0 text-gray-800">List Authors : </h5>
</div>
...
<table class="table table-striped w-75">
    <thead>
        <tr>
          ...
          <th scope="col">Created Authors</th>
