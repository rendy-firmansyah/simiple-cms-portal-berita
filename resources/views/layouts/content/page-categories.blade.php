...
<form method="POST" action="{{route('categories.store')}}">
    ...
    <div class="mb-3">
      ...
      <input type="text" name="categories" class="form-control w-25" id="categories" placeholder="Enter a name categories">
    </div>
    <button type="submit" class="btn btn-primary w-25">Add Data</button>
</form>
